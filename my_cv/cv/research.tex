...
%---------------------------------------------------------
  ...
  \cventry
    {\href{https://amslaurea.unibo.it/30082/}{\underline{MSc Thesis}} - International Internship Program} % Job title
...
%---------------------------------------------------------
  \cventry
    {\href{https://github.com/Freddavide/Freddavide/blob/main/elaborato_B036_Baldelli_Davide.pdf}{\underline{BSc Thesis}}} % Job title
